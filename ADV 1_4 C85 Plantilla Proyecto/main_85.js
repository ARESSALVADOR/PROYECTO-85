...
"pollo tandoori pizza", "veg suprema pizza", "paneer tikkka pizza","deluxe veggie pizza", "veg extravaganza pizza"   ];
...
function add_suggestion(){
	...
	var item = document.getElementById(" agregar elemento ").value;
